...
import hydra
from experiments.sensitive_attribute_artificial_dataset.artificial_salary_implicit.artificial_salary_dataset_benchmark import (
    ArtificialSalaryDataset,
)
from experiments.sensitive_attribute_artificial_dataset.artificial_salary_implicit.make_artificial_salary_dataset import (
...
def main(cfg: DictConfig) -> None:
    ...
    for salary_column in salary_columns:
        for currency in currencies:
            ...
            data_generator = ArtificialSalaryDataset(
                artificial_salary_dataset_path,
