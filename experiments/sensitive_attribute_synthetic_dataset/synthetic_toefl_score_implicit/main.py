...
from experiments.sensitive_attribute_synthetic_dataset.synthetic_toefl_score_implicit.make_synthetic_toefl_score_implicit_dataset import (
    ArtificialScoreTableGenerator,
)
from experiments.sensitive_attribute_synthetic_dataset.synthetic_toefl_score_implicit.synthetic_toefl_score_dataset_benchmark import (
    ArtificialTOEFLScoreDataset,
)
...
def main(cfg: DictConfig) -> None:
    ...
    data_generator = ArtificialTOEFLScoreDataset(
        artificial_score_dataset_path,
