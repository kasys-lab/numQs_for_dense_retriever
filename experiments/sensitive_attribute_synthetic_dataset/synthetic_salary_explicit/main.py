...
import hydra
from experiments.sensitive_attribute_artificial_dataset.artificial_salary_explicit.artificial_salary_dataset_benchmark import (
    ArtificialSalaryExplicitDataset,
)
from experiments.sensitive_attribute_artificial_dataset.artificial_salary_explicit.make_artificial_salary_dataset import (
    ArtificialSalaryTable,
)
...
def main(cfg: DictConfig) -> None:
    ...
    artificial_salary_dataset_path = f"{output_dir}/artificial_salary_dataset.csv"

    num_names = cfg.dataset.num_names
    num_category_pairs = cfg.dataset.num_category_pairs
    salary_range = cfg.dataset.salary_range
    salary_step = cfg.dataset.salary_step
    country_codes = cfg.dataset.country_codes
    job_dataset_dir = cfg.dataset.job_dataset_dir
    seed = cfg.dataset.seed

    ArtificialSalaryTable.generate_csv(
        artificial_salary_dataset_path,
        num_names=num_names,
    ...
    salary_number_column = "salary"

    for salary_column in salary_columns:
        for currency in currencies:
            benchmark_output_dir = f"{output_dir}/benchmark_{salary_column}_{currency}"
            ...
            data_generator = ArtificialSalaryExplicitDataset(
                artificial_salary_dataset_path,
