...
class ArtificialSalaryExplicitDataset(NumericalConditionDatasetBuilderBase):
    def __init__(
        self,
        csv_data_filepath,
    ...
    def generate_corpus_text(
        ...
        corpus_text = f"{name} is a {gender} working in a {industry_text} company with a {skill_text} job, and the salary is {number_text} in {coutry_name}."
